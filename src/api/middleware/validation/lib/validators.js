...
module.exports = {
    ...
    isPostalCode: (field, str = "") => validator.isPostalCode(str, "any") ? null : `${field} is not a valid Postal Code`,
    isMobilePhone: (field, str = "") => validator.isMobilePhone(str, "any", { strictMode: true }) ? null : `${field} is not a valid Phone number`
}